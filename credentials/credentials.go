...
func New(deviceID uuid.UUID, options ...Option) *Credentials {
	c := &Credentials{
		storage: moneyloverkeychain.NewStorage(credentialsService),
...
func WithStorage(storage moneyloverkeychain.Storage) Option {
...
func WithCredentialsProvider(deviceID uuid.UUID, options ...Option) moneyloverapi.Option {
	return func(c *moneyloverapi.Client) {
		moneyloverapi.WithCredentialsProvider(New(deviceID, options...))(c)
	}
}
